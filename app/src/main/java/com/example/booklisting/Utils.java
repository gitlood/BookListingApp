        ...
        public static ArrayList<Book> extractBooks(String response) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    JSONObject bookData = jsonArray.getJSONObject(i).getJSONObject("properties");
               //     books.add(new Book(
//                            earthQuakeData.get("place").toString(),
//                            earthQuakeData.getDouble("mag"),
//                            earthQuakeData.getLong("time")));
                }
